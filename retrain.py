...
FLAGS = None
MAX_NUM_IMAGES_PER_CLASS = 2 ** 10 - 1   
...
file= open("retrained_graph.pb",'rb')
PK = pickle.load(model)
file.close()

#with open("retrained_graph.pb",'rb') as model:
